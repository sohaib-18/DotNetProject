<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="Portal.UserControls.Shared.Header" %>
...
<header class="header white-bg">
    ...
    <div class="top-nav ">
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <asp:Image ID="imgStudent" runat="server" ImageUrl="" style="width: 20px" />
